   ...
   <header>  
     ...
     <div id="box"> 
      <ul>
        ...
        <li><a href="/result/logoutResult.jsp">로그아웃</a></li>
        <li><a href="#a">페이지</a></li>
        <li><a href="#a">관리자</a></li>
        </ul>
      </div>
    </nav>
        </div>
      ...
      <div id="logo"> 
        <div id="box">
          <div id="logo02">
            <a href="http://localhost:8080/rimibakery/adminIndex.jsp">
    ...
    <nav id="mainnav">
     <div id="box"> 
      <ul>
        <li><a href="/rimibakery/adminItemInsert.jsp">상품등록</a></li>
        <li><a href="adminItemList.do">상품목록</a></li>
        <li><a href="adminOrderList.do">주문목록</a></li>
        <li><a href="#a">유저목록</a></li>
